...
-- at runtime using the environment variable rosetta_json_bindir.
...
-- environment variable rosetta_json_libdir.
...
-- using the environment variable rosetta_json_dynlibdir.
...
-- runtime using the environment variable rosetta_json_datadir.
...
-- variable rosetta_json_libexedir.
...
-- using the environment variable rosetta_json_sysconfdir.
...
bindir     = "/home/ikawamuk/sgoinfre/.cabal/bin"
libdir     = "/home/ikawamuk/sgoinfre/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3/rosetta-json-0.1.0.0-inplace"
dynlibdir  = "/home/ikawamuk/sgoinfre/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3"
datadir    = "/home/ikawamuk/sgoinfre/.cabal/share/x86_64-linux-ghc-9.10.3-b4c3/rosetta-json-0.1.0.0"
libexecdir = "/home/ikawamuk/sgoinfre/.cabal/libexec/x86_64-linux-ghc-9.10.3-b4c3/rosetta-json-0.1.0.0"
sysconfdir = "/home/ikawamuk/sgoinfre/.cabal/etc"

getBinDir     = catchIO (getEnv "rosetta_json_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "rosetta_json_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "rosetta_json_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "rosetta_json_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "rosetta_json_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "rosetta_json_sysconfdir") (\_ -> return sysconfdir)
